        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-20">
          <div className="mb-6 lg:mb-0">
            <div className="inline-flex items-center gap-4 mb-8">
              <div className="w-16 h-16 bg-gradient-to-br from-unipas-accent to-unipas-primary rounded-2xl flex items-center justify-center shadow-2xl">
            ...
            <div key={event.id} className="group relative">
              <div className="h-full bg-white/90 backdrop-blur-md rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-500 border border-white/50 hover:border-unipas-accent/30">
                ...
                <div className="p-8">
                  ...
                  {/* Title */}
                  <h3 className="text-xl md:text-2xl font-black text-gray-800 mb-4 line-clamp-2 group-hover:text-unipas-accent transition-colors duration-300">
                    {event.title}
                  </h3>
